...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TAB  ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,KC_BRDN ,
                                                                        KC_BRUP ,KC_Y    ,KC_U    ,KC_I    ,KC_O    ,KC_P    ,KC_TRNS ,
    KC_ESCP ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_HYPR ,
                                                                        KC_TRNS ,KC_H    ,KC_J    ,KC_K    ,KC_L    ,KC_P    ,KC_TRNS ,
    KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,
                                                                                 KC_N    ,KC_M    ,KC_TRNS ,KC_TRNS ,KC_TRNS ,KC_RSFT ,
...
void keyboard_post_init_user(void) {
  rgb_matrix_enable();
  rgb_matrix_mode_noeeprom(RGB_MATRIX_MULTISPLASH);  // Force multisplash mode
